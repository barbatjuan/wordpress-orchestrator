...
|---|---|---|
| Contenedores (toda sección, migas y pie) | Contenedor exterior a ancho completo con relleno lateral del 7,5% + contenedor interior «en caja» de 1224px | El tope es el del contenido, no el de la caja: el raíl es el 7,5% hasta 1440 y (ancho − 1224) / 2 por encima, el mismo en cabecera, migas, secciones, foto a sangre y pie. Con la caja topada a 1440 y el relleno dentro, a 1920 el contenido medía 1152 y las piezas sin tope se iban a otro raíl |
...
| Fotografía a sangre | Contenedor rejilla de dos pistas (datos 300 · foto) con hueco de columna de 16% en portada y la marca y de 56 en la ficha, relleno izquierdo de 7,5% y cero a la derecha, ancho personalizado `calc(57.5% + 612px)` alineado a la derecha + Imagen. En tableta y móvil, una columna y relleno derecho de 8,108% en el contenedor de datos | La sangre es el relleno asimétrico del contenedor, no un margen negativo. El ancho alineado a la derecha pone los datos en el raíl de los contenedores por encima de 1440 y deja la foto tocando el cristal; por debajo de 1440 vale el ancho completo. El hueco es el aire del lienzo entre los datos y la foto (212 y 56 a 1440): como hueco y no como pista vacía no pide un contenedor vacío. El relleno derecho en una columna devuelve a los datos el mismo margen que a la izquierda |
